...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
		...
		if (balanceBefore + depositAmount == balanceAfter)
			...
			System.out.println(TestUtils.TEXT_COLOR_RED + "testWithdrawals: TC1 FAILED XXX: balanceBefore + depositAmount != balanceAfter");
			System.out.format("testWithdrawals: balanceBefore = %.2f ; depositAmount = %.2f ; balanceAfter = %.2f %s\n", 
					balanceBefore , depositAmount , balanceAfter, TestUtils.TEXT_COLOR_RESET);
		}
